...
#' \describe{
#'   \item{\code{\link{mpa}}}{Main optimization function implementing the MPA algorithm}
#'   \item{\code{\link{get_function_details}}}{Retrieve benchmark function parameters}
#' }
#'
#' @section Helper Functions:
#' \describe{
#'   \item{\code{\link{levy}}}{Generate Levy flight random steps}
#'   \item{\code{\link{initialize_population}}}{Initialize search agent population}
#' }
#'
...
#' Useful links:
#' \itemize{
#'   \item GitHub repository: \url{https://github.com/urbs-dev/mpa}
#'   \item Report bugs: \url{https://github.com/urbs-dev/mpa/issues}
#' }
#'
#' @keywords internal
"_PACKAGE"
